...
namespace Auto_Packet
{
    public partial class Click : Form
    {
        ...
        public Click()
        {
            ...
            //TODO: Edit this to make the user able to register custom hotkeys.
            RegisterHotKey(this.Handle, 0, (int)KeyModifier.Shift, Keys.Z.GetHashCode());       // Register Shift + Z as global hotkey. 
        }
